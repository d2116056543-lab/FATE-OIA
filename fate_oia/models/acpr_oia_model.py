...
class ACPROIAModel(nn.Module):
    def __init__(
        ...
        pair_tail_multiplier: float = 2.0,
    ) -> None:
        super().__init__()
        ...
        self.pair_memory = ACPRPairMemory(
            ...
            tail_multiplier=pair_tail_multiplier,
            memory_device=pair_memory_device,
        )
    ...
    def forward(self, images: torch.Tensor, epoch: int = 0) -> dict[str, torch.Tensor | dict | tuple[int, int] | int]:
        ...
        out = {
            ...
            **action_set,
            **pace,
            "action_logits_legacy_base": pace["action_logits_legacy"],
            "reason_logits_visual": trunk["reason_logits_visual"],
            "reason_evidence_shared": reason_logits_base,
            "action_reason_logits_visual": trunk["action_reason_logits_visual"],
