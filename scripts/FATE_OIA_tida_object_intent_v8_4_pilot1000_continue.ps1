...
$output = "F:\FATE_Drive_runs\tida_object_intent_v8_4_pilot1000_multihot_fix"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --checkpoint "F:\FATE_Drive_runs\tida_object_intent_v8_4_pilot1000\checkpoint_epoch_000.pth" `
