...
$output = "F:\FATE_Drive_runs\tida_trajectory_v6_0_relational_continue"
$checkpoint = "F:\FATE_Drive_runs\tida_trajectory_v5_9_control_centered_continue\checkpoint_epoch_001.pth"
$log = Join-Path $output "relational_probe.log"
