...
$output = "F:\FATE_Drive_runs\tida_trajectory_v7_1_selective_state_continue"
$checkpoint = "F:\FATE_Drive_runs\tida_trajectory_v7_0_dual_state_continue\checkpoint_epoch_001.pth"
$log = Join-Path $output "selective_state_probe.log"
...
& $python -u -m fate_oia.engine.train_tida_oia `
    ...
    --train-owners traffic_trajectory,traffic_trajectory_utility 2>&1 | Tee-Object -FilePath $log
