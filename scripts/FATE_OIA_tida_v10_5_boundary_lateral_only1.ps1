...
$output = "G:\FATE_Drive_runs\tida_v10_5_boundary_lateral_only1"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --checkpoint "G:\FATE_Drive_runs\tida_v10_4_boundary_aligned_lateral1\checkpoint_latest.pth" `
  ...
  --train-owners "object_intent_lateral_refinement" `
