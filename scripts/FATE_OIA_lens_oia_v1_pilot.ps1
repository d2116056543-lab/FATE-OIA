...
& E:\Anaconda\envs\sbw39\python.exe -u -m fate_oia.engine.train_lens_oia --config $Config --output-dir $OutputDir --epochs 4 --max-train-samples 4096 --max-test-samples 512 --device $Device
