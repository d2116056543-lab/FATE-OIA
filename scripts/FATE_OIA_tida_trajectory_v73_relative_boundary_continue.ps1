...
$output = "F:\FATE_Drive_runs\tida_trajectory_v7_3_relative_boundary_continue"
$checkpoint = "F:\FATE_Drive_runs\tida_trajectory_v7_1_selective_state_continue\checkpoint_epoch_000.pth"
$log = Join-Path $output "relative_boundary_probe.log"
...
& $python -u -m fate_oia.engine.train_tida_oia `
    ...
    --train-owners traffic_adaptive_boundary 2>&1 | Tee-Object -FilePath $log
