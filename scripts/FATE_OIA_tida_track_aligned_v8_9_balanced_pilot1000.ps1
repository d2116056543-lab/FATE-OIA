...
$output = "F:\FATE_Drive_runs\tida_track_aligned_v8_9_balanced_pilot1000"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --clip-manifest "artifacts\tida_10k_v8\tida_balanced_pilot1000_manifest.jsonl" `
  --image-checkpoint "F:\FATE_Drive_runs\vetra_replay_from_scratch_v2_full_20260819_retry1\checkpoint_stage_b_continued.pth" `
  --checkpoint "F:\FATE_Drive_runs\tida_object_intent_v8_7_rank_safe_pilot1000_retry1\checkpoint_epoch_000.pth" `
  --checkpoint-view online `
  --object-track-store "F:\FATE_Drive_runs\tida_object_tracks_balanced1000_calib779_test885.pt" `
  ...
  --max-calib-samples 779 --max-test-samples 885 --max-optimizer-updates 42 `
  --schedule-total-updates 42 --train-owners "object_intent_action,object_intent_reason" `
