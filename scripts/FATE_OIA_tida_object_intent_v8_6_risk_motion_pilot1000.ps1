...
$output = "F:\FATE_Drive_runs\tida_object_intent_v8_6_risk_motion_pilot1000"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --checkpoint "F:\FATE_Drive_runs\tida_object_intent_v8_5_decoupled_pilot1000\checkpoint_epoch_000.pth" `
