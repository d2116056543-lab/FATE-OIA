...
$output = "G:\FATE_Drive_runs\tida_v10_1_dual_utility1"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --checkpoint "G:\FATE_Drive_runs\tida_v10_source_complete_utility2\checkpoint_latest.pth" `
  ...
  --max-calib-samples 838 --max-test-samples 885 --max-optimizer-updates 253 `
  --schedule-total-updates 253 `
