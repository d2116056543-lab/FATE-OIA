...
$env:PYTHONPATH = "."
$output = "G:\FATE_Drive_runs\tida_v10_13_random_oof_eval_retry2"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --checkpoint "G:\FATE_Drive_runs\tida_v10_13_deploy_utility_refine1\checkpoint_latest.pth" `
  ...
  --verified-baseline-artifact "G:\FATE_Drive_runs\tida_v10_13_deploy_utility_refine1\TIDA_IMAGE_BASELINE_COVERED_SUBSET.json" `
  --policy-rows-artifact "G:\FATE_Drive_runs\tida_v10_13_deploy_utility_refine1\object_intent_policy_rows_train_only.pt" `
  ...
  --evaluation-only --random-utility-oof --run-kind smoke `
  --train-owners "object_intent_action_utility" `
