...
$output = "F:\FATE_Drive_runs\tida_trajectory_v5_9_control_centered_continue"
$checkpoint = "F:\FATE_Drive_runs\tida_trajectory_v5_9_control_centered_probe\checkpoint_epoch_000.pth"
$log = Join-Path $output "head_probe.log"
