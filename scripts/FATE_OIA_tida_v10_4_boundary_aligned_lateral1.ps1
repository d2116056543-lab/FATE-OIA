...
$output = "G:\FATE_Drive_runs\tida_v10_4_boundary_aligned_lateral1"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --checkpoint "G:\FATE_Drive_runs\tida_v10_3_lateral_refinement1\checkpoint_latest.pth" `
  ...
  --max-optimizer-updates 253 --schedule-total-updates 253 `
  --train-owners "object_intent_lateral_refinement,object_intent_action_utility,object_intent_reason_utility" `
