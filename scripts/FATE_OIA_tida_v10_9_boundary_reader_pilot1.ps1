...
$env:PYTHONPATH = "."
$output = "G:\FATE_Drive_runs\tida_v10_9_boundary_reader_pilot1"
...
& "E:\Anaconda\envs\sbw39\python.exe" -u -m fate_oia.engine.train_tida_oia `
  ...
  --max-optimizer-updates 86 --schedule-total-updates 86 `
  --train-owners "object_intent_action,object_intent_action_utility" `
  --policy-use-train-core --eval-every-epochs 1 --run-kind smoke `
