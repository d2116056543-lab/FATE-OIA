...
from fate_oia.utils.precise_schema import load_reason_semantics
...
def test_category_decoder_first_pass_contract_and_compositional_side_queries():
    decoder = PRECISECategoryDecoder(load_reason_semantics(ROOT / "configs" / "precise_reason_semantics.yaml"))
